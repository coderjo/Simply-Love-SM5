...
return Def.ActorFrame{
	LoadFont("titlemenu")..{
		Text=ScreenString("CasualDescription");
	...
	Def.ActorFrame{
		InitCommand=cmd(x,SCREEN_LEFT+65;y,SCREEN_CENTER_Y-125;horizalign,left);
		LoadActor(THEME:GetPathG("_join","icons/casual_icon"))..{
