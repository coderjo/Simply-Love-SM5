...
local PlayerP1MiscX = math.floor(scale((0.85/3),0,1,SCREEN_LEFT,SCREEN_RIGHT))
local PlayerP2MiscX = math.floor(scale((2.15/3),0,1,SCREEN_LEFT,SCREEN_RIGHT))
...
local function GetPosition(pn)
	...
	if p == 'P1' then return PlayerP1MiscX
	else return PlayerP2MiscX
	end
